 ...
 *
 * Based on lifecycletrigger_startdatedelay
 * 2017 Tobias Reischmann WWU.
 *
...
class enddatedelay extends base_automatic {
    ...
    /**
     * Add sql comparing the current date to the end date of a course in combination with the specified delay.
    ...
    public function get_course_recordset_where($triggerid) {
        ...
        // Courses with no enddate would not be returned.
        $params = array(
    ...
    /**
     * At the delay since the end date of a course.
